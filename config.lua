...
Config.MinimumStress = 9000 -- Minimum Stress Level For Screen Shaking
Config.MinimumSpeedUnbuckled = 9000 -- Going Over This Speed Will Cause Stress
Config.MinimumSpeed = 9000 -- Going Over This Speed Will Cause Stress
